...
\hypersetup{
  ...
  pdfauthor={MAA AACAAS MUHAMATH and M. A. Abdul Rafi},
...
\author{
\IEEEauthorblockN{Author\\MAA AACAAS MUHAMATH}
\IEEEauthorblockA{Department of Electrical Engineering\\
University of Moratuwa\\
Moratuwa, Sri Lanka\\
\texttt{muhamathmaa.23@uom.lk}}
\and
\IEEEauthorblockN{Collaborator\\M. A. Abdul Rafi}
\IEEEauthorblockA{Department of Computer Science and Engineering\\
University of Moratuwa\\
Moratuwa, Sri Lanka\\
\texttt{rafimaa.23@uom.lk}}
}
...
\centering
\input{../tables/dataset_distribution.tex}
\end{table}
...
\label{tab:robust}
\centering
\input{../tables/repeated_robustness.tex}
\end{table*}
...
\section*{Authors and Collaborator}
\textbf{Author:} MAA AACAAS MUHAMATH, Department of Electrical Engineering,
University of Moratuwa (\texttt{muhamathmaa.23@uom.lk}).

\textbf{Collaborator:} M. A. Abdul Rafi, Department of Computer Science and
Engineering, University of Moratuwa (\texttt{rafimaa.23@uom.lk}).
\end{document}
